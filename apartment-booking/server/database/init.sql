...
-- Эта таблица хранит профильную информацию пользователей
CREATE TABLE users (
    id TEXT PRIMARY KEY,
...
CREATE TABLE apartments (
    ...
    image_filename TEXT,
    image_url TEXT,  -- URL изображения (для загруженных файлов)
    created_date TEXT DEFAULT CURRENT_TIMESTAMP,
    updated_date TEXT DEFAULT CURRENT_TIMESTAMP
);
...
CREATE TABLE bookings (
    ...
    user_id TEXT,  -- Опционально: связь с пользователем
...
INSERT INTO users (id, email, full_name, phone, preferences, profile_completed)
VALUES 
('user_1', 'test@example.com', 'Иван Петров', '+7 (999) 123-45-67', '{"smoking":false,"pets":false,"early_checkin":true}', 1);
